---
title: "WT_control_vs_KO_Control_report.Rmd"
author: "prj4998"
date: "`r Sys.Date()`"
...
columns_to_include <- c("Gene_name","WT_control_001", "WT_control_002","WT_control_003","WT_control_004","WT_control_005",
...
coldata <- data.frame(
  sample = c(
    "WT_control_001", "WT_control_002","WT_control_003","WT_control_004","WT_control_005",
     "KO_control_001", "KO_control_002","KO_control_003","KO_control_004","KO_control_005"
  ),
  angiotensinII = c(
    rep("untreated", 10)
...
dds <- DESeq(dds)
res <- results(dds) # Interaction term, we are using contrast to figure out the compasiosn to make.
res
...
write_csv(res1,"WT_KO_control_nolfcThreshold_Aug16.csv")
resultsNames(dds)
```
