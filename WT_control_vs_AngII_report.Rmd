---
title: "WT_control_vs_AngII_report.Rmd"
author: "prj4998"
date: "`r Sys.Date()`"
...
libs <- c("tidyverse", "ggVennDiagram", "BiocManager",
          "DESeq2", "edgeR", "limma", "pheatmap","dplyr","RColorBrewer","ggplot2","data.table","ggrepel","msigdbr","clusterProfiler","fgsea","biomaRt","DT","ggplot2","viridis")
...
write_csv(res1,"WT_control_AngII_Aug16.csv")
resultsNames(dds)
```
...
write.csv(results_with_gene_column,"WT_control_AngII.csv" )
genelist
```
...
write_csv(labeled_results,"WT_control_vs_AngII.csv")
write_csv(labeled_results['Gene_name'],"HOMER_ALL_1_WT.csv")
write_csv(genes_up['Gene_name'],"HOMER_UP_1_WT.csv")
write_csv(genes_down['Gene_name'],"HOMER_DOWN_1_WT.csv")
